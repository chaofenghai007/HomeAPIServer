...
namespace ConsoleImageMatch.MatchService {
    ...
    public partial class MatchedImageResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private ConsoleImageMatch.MatchService.MatchedImage[] MatchedImagesk__BackingFieldField;
        ...
        public ConsoleImageMatch.MatchService.MatchedImage[] MatchedImagesk__BackingField {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MatchService.IImageAnalysisService")]
    public interface IImageAnalysisService {
        ...
        ConsoleImageMatch.MatchService.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageAnalysisService/MatchImage", ReplyAction="http://tempuri.org/IImageAnalysisService/MatchImageResponse")]
        System.Threading.Tasks.Task<ConsoleImageMatch.MatchService.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IImageAnalysisServiceChannel : ConsoleImageMatch.MatchService.IImageAnalysisService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ImageAnalysisServiceClient : System.ServiceModel.ClientBase<ConsoleImageMatch.MatchService.IImageAnalysisService>, ConsoleImageMatch.MatchService.IImageAnalysisService {
        ...
        public ConsoleImageMatch.MatchService.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize) {
            return base.Channel.MatchImage(source, ratio, category, pageIndex, pageSize);
        }
        
        public System.Threading.Tasks.Task<ConsoleImageMatch.MatchService.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize) {
