...
namespace MVCTestImageMatch.AnalysisOld {
    ...
    public partial class MatchedImageResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private MVCTestImageMatch.AnalysisOld.MatchedImage[] MatchedImagesk__BackingFieldField;
        ...
        public MVCTestImageMatch.AnalysisOld.MatchedImage[] MatchedImagesk__BackingField {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AnalysisOld.IImageAnalysisService")]
    public interface IImageAnalysisService {
        ...
        MVCTestImageMatch.AnalysisOld.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageAnalysisService/MatchImage", ReplyAction="http://tempuri.org/IImageAnalysisService/MatchImageResponse")]
        System.Threading.Tasks.Task<MVCTestImageMatch.AnalysisOld.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IImageAnalysisServiceChannel : MVCTestImageMatch.AnalysisOld.IImageAnalysisService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ImageAnalysisServiceClient : System.ServiceModel.ClientBase<MVCTestImageMatch.AnalysisOld.IImageAnalysisService>, MVCTestImageMatch.AnalysisOld.IImageAnalysisService {
        ...
        public MVCTestImageMatch.AnalysisOld.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize) {
            return base.Channel.MatchImage(source, ratio, category, pageIndex, pageSize);
        }
        
        public System.Threading.Tasks.Task<MVCTestImageMatch.AnalysisOld.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize) {
