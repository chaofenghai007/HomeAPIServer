...
namespace SCServicesMonitoring.PicMatch {
    ...
    public partial class MatchedImageResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private SCServicesMonitoring.PicMatch.MatchedImage[] MatchedImagesk__BackingFieldField;
        ...
        public SCServicesMonitoring.PicMatch.MatchedImage[] MatchedImagesk__BackingField {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PicMatch.IImageAnalysisService")]
    public interface IImageAnalysisService {
        ...
        SCServicesMonitoring.PicMatch.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImageAnalysisService/MatchImage", ReplyAction="http://tempuri.org/IImageAnalysisService/MatchImageResponse")]
        System.Threading.Tasks.Task<SCServicesMonitoring.PicMatch.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IImageAnalysisServiceChannel : SCServicesMonitoring.PicMatch.IImageAnalysisService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ImageAnalysisServiceClient : System.ServiceModel.ClientBase<SCServicesMonitoring.PicMatch.IImageAnalysisService>, SCServicesMonitoring.PicMatch.IImageAnalysisService {
        ...
        public SCServicesMonitoring.PicMatch.MatchedImageResult MatchImage(string source, double ratio, string category, int pageIndex, int pageSize) {
            return base.Channel.MatchImage(source, ratio, category, pageIndex, pageSize);
        }
        
        public System.Threading.Tasks.Task<SCServicesMonitoring.PicMatch.MatchedImageResult> MatchImageAsync(string source, double ratio, string category, int pageIndex, int pageSize) {
